	...
	public class CharAnimCached {
		...
		public function CharAnimCached(anim:MovieClip) {
			...
			for (var i:int = 1; i <= mc.totalFrames; i++) {
				...
				var shoes2:Array = [];
				var hands2:Array = [];
				CharAnimConfig.isolateChildren(getChildFrom(mc, [0, 0]), shoes1); //shoes
				CharAnimConfig.isolateChildren(getChildFrom(mc, [0, 1]), hands1); //hands
				getChildFrom(mc, [0, 2]);
				...
				CharAnimConfig.isolateChildren(getChildFrom(mc, [0, 5]), shoes2); //shoes
				CharAnimConfig.isolateChildren(getChildFrom(mc, [0, 6]), hands2); //hands
