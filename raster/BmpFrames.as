	...
	public class BmpFrames {
		...
		public static function createBmpFramesFromMC(clipClass : MovieClip) : BmpFrames {
			...
			for (var i : int = 1; i <= totalFrames; i++) {
				...
				mtx.tx = -flooredX * koef;
				mtx.ty = -flooredY * koef;
				
				scratchBitmapData = new BitmapData(rect.width * koef, rect.height * koef, true, 0);
				...
				matrix.scale(1 / koef, 1 / koef);
				var bmpData2:BitmapData = new BitmapData(trimBounds.width / koef, trimBounds.height / koef);
